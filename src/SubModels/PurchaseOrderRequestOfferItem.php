 ...
 * @property string|null $containerQuantity
 ...
 * @property string|null $minQuantity
 ...
 * @property string|null $purchaseOrderRequestItemId
 * @property string|null $quantity
 * @property array|null $reductionAdditionItems
 * @property string|null $scaleType
 * @property array|null $scaleValues
 ...
 * @property bool|null $useSupplierArticleNumber
 */
class PurchaseOrderRequestOfferItem extends SubModel {}
