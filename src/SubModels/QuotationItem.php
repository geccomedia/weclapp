 ...
 * @property string|null $itScopeId
 * @property string|null $itemType
 * @property int|null $lastModifiedDate
 * @property string|null $manualPlannedWorkingTimePerUnit
 ...
 * @property string|null $plannedWorkingTimePerUnit
 * @property int|null $positionNumber
 * @property string|null $quantity
 * @property array|null $quotationItemRelationships
 ...
 */
class QuotationItem extends SubModel {}
